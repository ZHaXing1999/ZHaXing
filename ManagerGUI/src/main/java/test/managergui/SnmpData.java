...
public class SnmpData {
    ...
    public static CommunityTarget createDefault(String ip, String community) {
        ...
        target.setVersion(DEFAULT_VERSION); //设置或者获取版本号
        target.setTimeout(DEFAULT_TIMEOUT); // 超时时间
        target.setRetries(DEFAULT_RETRY); //重传次数
        return target;
    }
    /*根据OID，获取单条消息*/
    public static List<String> snmpGet(String ip, String community, String oid) {
        ...
        try {
            ...
            if (response == null) {
                ...
                for (int i = 0; i < response.size(); i++) {
                    ...
                    System.out.println(vb.getOid() + " = " + vb.getVariable());
                    idlist.add(vb.getOid() + " = " + vb.getVariable());
                }
    ...
    public static List<String> snmpAsynWalk(String ip, String community, String oid)
    {
        List<String> idlist=new ArrayList<>();
